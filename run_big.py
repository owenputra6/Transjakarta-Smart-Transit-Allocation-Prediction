"""
run_big.py — Inference Bus Besar TransJakarta
"""
import sys
...
# ── PATHS ─────────────────────────────────────────────────────────────────────
CSV_PATH       = Path("./dummy_test/predict_bus_besar.csv")
ARTIFACTS_DIR  = Path("./training_and_inferences/model_allocation")
OUTPUT_PATH    = Path("./hasil_big.csv")
...
df = inf.run_pipeline(str(CSV_PATH), "big", None, device)
df["bus_type"] = "big"
...
print("\n" + "="*70)
print("  HASIL ALOKASI BUS BESAR — per Corridor per Jam")
print("="*70)
